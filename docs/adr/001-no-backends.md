...
2. `MemoryStore` — a reference implementation for development and testing (deprecated as of v0.2.0; removal targeted for v1.0)
...
- `MemoryStore` is deprecated (v0.2.0) and will be removed in v1.0; it remains functional for development and testing. Supersedes the original "permanent reference implementation" stance.
