...
_Point-in-time snapshot. Living status lives in TODO_LIST.md / ROADMAP.md; section (f) is HARVEST-ready but intentionally not routed — awaiting instructions._
