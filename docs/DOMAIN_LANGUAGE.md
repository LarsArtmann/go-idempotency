...
| Term                   | Definition                                                                                                                                                                                                  |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Store**              | The interface (`store.go:30-48`) for tracking idempotency keys. Three methods: `Seen`, `Record`, `CheckAndRecord`.                                                                                          |
...
| **MemoryStore** | The in-memory `Store` implementation: `map[string]time.Time` guarded by `sync.RWMutex`. The only implementation currently shipped.                                                                                               |
