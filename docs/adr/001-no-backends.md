...
2. `MemoryStore` — a reference implementation for development and single-process use
...
- `MemoryStore` remains as a permanent reference implementation (not deprecated)
